...
pub struct GraphCopy {
    pub lens_aria: String,
    pub lens_projects: String,
    pub lens_stack: String,
    pub metric_aria: String,
    pub weight_calls: String,
    pub weight_spend: String,
    pub weight_tokens: String,
    ...
    pub canvas_aria: String,
    pub mode_3d: String,
    pub interaction_hint: String,
    pub keyboard_hint: String,
    pub legend_aria: String,
    pub kind_project: String,
    pub kind_tool: String,
    pub kind_model: String,
    pub kind_core_tool: String,
    pub kind_mcp_server: String,
    pub showing: String,
    pub truncated_hint: String,
    pub empty: String,
    pub loading: String,
    pub load_error: String,
    pub selection_empty_title: String,
    pub selection_empty_detail: String,
    pub selection_empty_hint: String,
    pub visible_entities: String,
    pub visible_links: String,
    pub weighted_by: String,
    pub relationships: String,
    pub last_active: String,
    pub open_details: String,
    pub relation_project_tool: String,
    pub relation_project_model: String,
    pub relation_tool_model: String,
    pub relation_project_core_tool: String,
    pub relation_tool_core_tool: String,
    pub relation_project_mcp_server: String,
    pub relation_tool_mcp_server: String,
    pub node_aria: String,
}
...
pub struct CoachTimelineCopy {
    ...
    pub est_hours: String,
    pub hot_files: String,
    pub pattern_mostly_weekdays: String,
    pub pattern_mostly_weekends: String,
    pub pattern_mixed_days: String,
    pub pattern_mornings: String,
    pub pattern_afternoons: String,
    pub pattern_evenings: String,
    pub pattern_late_nights: String,
    pub pattern_combo: String,
    pub day: String,
    pub calendar: String,
    pub less: String,
    pub more: String,
    ...
    pub sessions: String,
    pub turns: String,
    pub turns_header: String,
    pub bars_label: String,
...
pub struct CoachOutputCopy {
    ...
    pub by_month: String,
    pub monthly_hint: String,
    pub monthly_output: String,
    pub monthly_average: String,
...
pub struct SessionCopy {
    ...
    pub mode_unknown: String,
    pub quality_exact: String,
    pub quality_estimated: String,
    pub quality_mixed: String,
    pub quality_session: String,
...
pub struct DesktopCopy {
    ...
    pub by_provider: String,
    pub by_tool: String,
    pub per_tool_split: String,
    pub token_composition: String,
    pub pricing: String,
    pub pricing_fallback_note: String,
