...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_advice_tool,
            commands::prepare_advice_prompts,
            commands::generate_advice,
            commands::update_advice_item_status,
            ...
            commands::sync_claude_limits,
            commands::install_claude_statusline,
            commands::install_claude_statusline_manual,
            commands::uninstall_claude_statusline,
            commands::sync_copilot_limits,
            commands::sync_claude_subscription_limits,
            commands::sync_codex_subscription_limits,
            commands::set_claude_session_cookie,
            commands::clear_claude_session_cookie,
