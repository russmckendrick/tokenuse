...
`costs/pricing-overrides.json` and `costs/pricing-sources.json` are curated pricing config. Keep aliases, provenance, effective dates, and extraction rules there rather than in Rust.
