# tokenuse v0.0.5 - Activity Pulse
...
Homebrew tap updates now publish the desktop app as the `tokenuse-desktop` cask, leaving `tokenuse` dedicated to the TUI formula.
