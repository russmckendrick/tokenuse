...
- Fixed Codex usage parsing to derive call usage from cumulative token deltas when available, avoiding over-counting duplicate `token_count` snapshots with unchanged totals.
