...
- Greyed out redundant desktop filter controls on Usage and Config, with Usage showing fixed 24h/All/Spend defaults and matching shortcut behavior for inactive GUI filters.
