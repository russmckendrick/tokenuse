...
- Upgraded the desktop dashboard and tray popover with Motion-powered transitions, D3-backed activity charts, and D3 rank heat strips while preserving the dense dark Token Use console style.
